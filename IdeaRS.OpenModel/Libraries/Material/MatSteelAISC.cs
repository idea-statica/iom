...
namespace IdeaRS.OpenModel.Material
{
	...
	/// Material steel AISC
	/// </summary>
	[OpenModelClass("CI.StructModel.Libraries.Material.American.MatSteelASTM,CI.Material", "CI.StructModel.Libraries.Material.IMatSteel,CI.BasicTypes", typeof(MatSteel))]
